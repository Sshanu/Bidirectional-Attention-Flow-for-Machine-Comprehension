...
def _test(config):
    ...
    with open('data/squad/pos_x_test.json', 'r') as fh:
        pos_x_test = json.load(fh)

    pos_x_test = filter_pos_x(pos_x_test)

    with open('data/squad/pos_q_test.json', 'r') as fh:
        pos_q_test = json.load(fh)

    pos_q_test = filter_pos_q(pos_q_test)
    ...
    test_data.shared['pos_x'] = pos_x_test
    test_data.shared['pos_q'] = pos_q_test
